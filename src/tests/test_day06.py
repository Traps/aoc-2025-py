...
def test_part1_samples() -> None:
    ...
    assert part1_module.solve(samples[0]) == 4277556

def test_part1_challenge() -> None:
    challenge = get_challenge_input(DAY_NAME)

    assert part1_module.solve(challenge) == 6295830249262
...
def test_part2_samples() -> None:
    ...
    assert part2_module.solve(samples[0]) == 3263827

def test_part2_challenge() -> None:
    challenge = get_challenge_input(DAY_NAME)

    assert part2_module.solve(challenge) == 9194682052782
